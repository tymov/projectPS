...
function saveAudio($filename)
{
    ...
    $trackBPM = $_POST['trackBPM'];
    $trackKey = $_POST['trackKey'];
    ...
    $query = "INSERT INTO audios(filename, trackName, trackBPM, trackKey)values('{$filename}', '$trackName', '$trackBPM', '$trackKey')";
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <ul>
                        ...
                        <li><a class="nav-item nav-link" href="discover.php">DISCOVER</a></li>
                        <li><a class="nav-item nav-link active" href="upload.php">UPLOAD</a></li>
                    </ul>
                </div>
            </div>
        </nav>
...
<main class="content">
    <section>
        <form action="upload.php" method="post" enctype="multipart/form-data">
            ...
            <div class="file-upload pb-4">
                <button class="file-upload-btn" type="button" onclick="$('.file-upload-input').trigger( 'click' )">
                    Select files
                </button>

                <div class="image-upload-wrap">
                    <input class="file-upload-input" name="audioFile" type='file' onchange="readURL(this);"
                           accept="audio/mpeg"/>
                    <div class="drag-text">
                ...
                <span class="row container py-4">
                <label for="trackName" class="col-lg-12">Track Name
                    <input type="text" name="trackName" class="col-lg-12">
                </label>
                <label for="trackKey" class="col-lg-12">Track BPM
                    <input type="text" name="trackBPM" class="col-lg-12">
                </label> <br>
                <label for="trackKey" class="col-lg-12">Track Key
                    <input type="text" name="trackKey" class="col-lg-12">
                </label></span>
                <br>

                <input type="submit" value="Upload Audio" name="save_audio" class="btn btn-primary">
        </form>
    </section>
</main>
