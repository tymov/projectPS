        ...
        <div class="container text-center py-5">
            <div class="row">
                <div class="col-md-12 col-sm-12 intro">
                    <h1>Welcome to SoundShare</h1><br>
                    <h2>For producers</h2>
                    <p>Discover thousands of samples, beats, tracks, acapellas and much more <br>
                        on SoundShare</p>
                    <div class="container-search">
                        <input type="text" id="box" placeholder="Explore samples..." class="search__box">
...
<main class="content">
    ...
    <section class="container pb-5 fade-up">
        <div class="form-modal text-center p-3">
